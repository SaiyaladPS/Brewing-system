<link rel="stylesheet" href="../assets/css/bootstrap.min.css">
    ...
    province as a,district as b where b.recover='0' and a.pro_id=b.pro_id and (b.dis_id like'$data%' or b.dis_name like'$data%' or a.pro_name like'$data%') order by b.dis_id desc";
