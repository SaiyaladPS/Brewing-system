...
<?php
						include("connect_dbstock.php");
							$sum_r = mysqli_query($conn,"select sum(amount) from orders ");
							$sum_rr = mysqli_query($conn,"select sum(amount) from orders where odate=curdate() ");
							
							$amount_r = mysqli_fetch_array($sum_r);
							$amount_rr = mysqli_fetch_array($sum_rr);
							
							
							$maxre = mysqli_query($conn,"select pro_name from orders as a,products as b where a.pro_id=b.pro_id and oqty=(select max(oqty) from orders); ");
							$minre = mysqli_query($conn,"select pro_name from orders as a,products as b where a.pro_id=b.pro_id and oqty=(select min(oqty) from orders);");
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            <div class="small-box bg-info">
              ...
              <a href="receives/selectre.php" class="small-box-footer">ລາຍຮັບທັງໝົດ <i class="fas fa-dollar-sign"></i></a>
            </div>
          </div>
		  <div class="col-lg-3 col-6">
            <div class="small-box bg-warning">
              ...
              <a href="receives/selectre_today.php" class="small-box-footer"> ລາຍຮັບມື້ນີ້ <i class="fas fa-dollar-sign"></i></a>
            </div>
          </div>
          <div class="col-lg-3 col-6">
            <div class="small-box bg-success">
              <div class="inner">
                <h4>ສີນຄ້າທີ່ໄດ້ຂາຍດີທີສຸດ</h4>
              ...
              <a href="orders/select_max_order.php" class="small-box-footer">ສີນຄ້າທີ່ໄດ້ຂາຍດີທີສຸດ <i class="fas fa-dollar-sign"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-6">
            <div class="small-box bg-danger">
              <div class="inner">
                <h4>ສີນຄ້າທີ່ໄດ້ຂາຍໜ້ອຍທີ່ສຸດ</h4>
              ...
              <a href="orders/selector_min_order.php" class="small-box-footer"> ສີນຄ້າທີ່ໄດ້ຂາຍໜ້ອຍທີ່ສຸດ <i class="fas fa-dollar-sign"></i></a>
            </div>
          </div>
        </div>
			<hr>
