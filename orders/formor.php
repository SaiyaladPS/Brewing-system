<html>
	...
	<div class="container-fluid">
			<div class="card">
				<div class="card-header" style="font-size:24px;">
					<div class="row">
						<div class="col-md-4"><b>ຟອນບັນທືກສີນຄ້າຂາຍອອກ</b></div>
						<div class="col-md-7">
							<div class="tableproducts"><center><b>ລາຍງານສີນຄ້າໃນສາງ</b></center></div>
							<div class="tableoder"><center><b>ລາຍງານສີນຄ້າທີສັ່ງຊື້</b></center></div>
							
						</div>
						<div class="col-md-1">
							<button class="btn btn-danger" id="buttonproducts" style="font-size:16px;">ເຄື່ອງໃນສາງ</button>
							<button class="btn btn-info" id="buttonorder" style="font-size:16px;">ສີນຄ້າທີສັ່ງຊື້</button>
						</div>
					</div>
			...
			<div class="row">
						...
						<form class="form-vertical">
							...
							<input type="text" hidden name="bill_fly" id="bill_fly" value="<?php date_default_timezone_set("Asia/bangkok");
                    echo "101".date("his");?>" class="form-control">
							</div>
							<div class="form-group">
								
									<input type="text" placeholder="ລະຫັດລູກຄ້າ!" class="form-control" id="cus_id">
							</div>
							<div class="form-group">
								
								<input type="text" readonly placeholder="ຊື່ລູກຄ້າ!" class="form-control" id="fname">
							</div>
	...
	?>
		...
		$select = mysqli_query($conn,"select a.*,b.*,c.* from products as a,
		orders as b,customer as c where b.pro_id=a.pro_id and c.cus_id=b.cus_id and selec='1' order by b.or_id desc");
	...
	<h6><b>ຈຳນວນສີນຄ້າ <?php echo number_format($check_count[0]);?> ລາຍການ ລວມເປັນເງີນທັງໝົດ :  <?php echo number_format($check_sum[0]);?> ກີບ </b></h6>
		...
		<div class="showhere">
			...
			?>
					...
					<td width="15px">
					<a href="reset.php?pro_id=<?php echo $data['pro_id'];?> & oqty=<?php echo $data['oqty']; ?>" onclick="return confirm('ທ່ານຕ້ອງການຍົກເລີກລາຍການນີ້ບໍ່ ?')">
