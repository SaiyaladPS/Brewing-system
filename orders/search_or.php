...
<?php
				include("connect.php");
				$data=$_POST["data"];
				$sql1="select bill_fly,sum(amount) as amount,count(or_id) as or_id,fname from orders as a,customer as b where a.cus_id=b.cus_id and selec='2' and (bill_fly like'$data%' or fname like'$data%') group by bill_fly desc ";
